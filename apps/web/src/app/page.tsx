    ...
    <main className="min-h-screen bg-[#FAFBFC] text-[#0f172a]">
      ...
      <section className="relative overflow-hidden pt-32 pb-24 md:pt-40 md:pb-32">
        ...
        <div className="relative mx-auto max-w-7xl px-6 text-center">
          ...
          <h1 className="mx-auto max-w-5xl text-5xl font-bold leading-[0.95] tracking-[-2.5px] md:text-7xl lg:text-8xl">
            The Operating System for <span className="italic text-zinc-400">School Mental Wellbeing</span>
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-zinc-500 leading-relaxed">
            From early detection to crisis intervention — Firefly Health empowers schools with proactive, multi-tiered care systems that transform student wellbeing.
          </p>
          ...
          <div className="mt-16 grid gap-4 sm:grid-cols-3 max-w-3xl mx-auto">
            <div className="rounded-2xl border border-black/5 bg-white p-5 text-left shadow-sm">
              <p className="text-lg font-semibold text-black">Schools Onboarded</p>
              <p className="text-sm text-zinc-500 mt-1">Partner schools across regions</p>
            </div>
            <div className="rounded-2xl border border-black/5 bg-white p-5 text-left shadow-sm">
              <p className="text-lg font-semibold text-black">Students Supported</p>
              <p className="text-sm text-zinc-500 mt-1">Active student wellbeing records</p>
            </div>
            <div className="rounded-2xl border border-black/5 bg-white p-5 text-left shadow-sm">
              <p className="text-lg font-semibold text-black">Crisis Response</p>
              <p className="text-sm text-zinc-500 mt-1">Timely escalation and interventions</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="border-t border-black/5 bg-white py-24">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="text-3xl font-bold tracking-tight md:text-4xl">Complete Wellbeing Intelligence System</h2>
            <p className="mt-4 text-zinc-500">Everything your school needs for proactive mental health support, from MTSS-based care to Supreme Court compliance.</p>
          </div>
      ...
      <section className="border-t border-black/5 bg-black py-24 text-white">
        <div className="mx-auto max-w-3xl px-6 text-center">
          <h2 className="text-3xl font-bold tracking-tight md:text-4xl">Ready to Transform School Wellbeing?</h2>
          <p className="mt-4 text-zinc-400">Join schools using Firefly Health for proactive, data-driven mental health support.</p>
          <Link
            href="/login"
